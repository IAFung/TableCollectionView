...
//    [cell.collectionView setContentOffset:CGPointMake(horizontalOffset, 0)];
    NSValue *value = self.contentOffsetDictionary[indexPath];
    [cell.collectionView setContentOffset:value.CGPointValue];
    
}
- (void)tableView:(UITableView *)tableView didEndDisplayingCell:(AFTableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    CGPoint point = cell.collectionView.contentOffset;
    self.contentOffsetDictionary[indexPath] = [NSValue valueWithCGPoint:point];
}
